...
def hypothesis_function(parameters, x_features):
	...
	for i in range(len(parameters)):                              			# Executes one case from the dataset (1 Row).
...
#                                                         1. Process Dataset                                                             #
# ====================================================================================================================================== #
# Import x's (atributes) from the dataset.
...
# Import y (target) from the dataset.
...
# Scale the dataset with minimum - maximum normalization.
